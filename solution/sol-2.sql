...
ALTER TABLE CLASS ADD CONSTRAINT FK_ROOM FOREIGN KEY (ROOM_ID) REFERENCES ROOM (ROOM_ID);

ALTER TABLE ROOM ADD CONSTRAINT FK_CLASS FOREIGN KEY (CLASS_ID) REFERENCES CLASS (CLASS_ID);
